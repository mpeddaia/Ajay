...
// Added for TD20791 wildcard search Q2FY13..nvelaga
...
// End of TD20791 wildcard search Q2FY13..nvelaga
...
function validateLength(value){
	...
	if(b==0 && (!trim(c) || trim(c).length<3 ))
		 return true;
	return false;
}

//Added for TD20791 Q2FY13 by nvelaga
function validateWildCards(value){
	var fld=takeAString(value);
	var a=new Array();
	var b=0;
	a=fld.split("");
