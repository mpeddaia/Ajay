...
<%@page import="java.util.ArrayList"%>
 <%   
    ...
    // End npunnam toolKit CR
    	...
    	//Added by amalekar as part of Q4FY15 July rel
    	 
   		 //Added by amalekar as part of Q4FY15 July rel
    	
    	System.out.println("In header.jsp ajay");
    	
    	String Training = null;
    	/* Start TD-18396 - Training Link updated for disti and reseller user - amalekar*/
	   	User user=(User)session.getAttribute("User");
	    String roleType = user.getChkRoleType(); 
	    
	    System.out.println("Role of User  : " + roleType);
	    
	    if(roleType.equalsIgnoreCase("2-TIER RESELLER")){
	  	  Training =prop.getProperty("app.Training.resellers.path");
	  	  System.out.println("2-TIER RESELLER Training  : " + Training);
	    }else if(roleType.equalsIgnoreCase("Distributor")){
	      Training =prop.getProperty("app.Training.distributors.path");
	      System.out.println("Distributor Training  : " + Training);
	    }else{
	      Training =prop.getProperty("app.Training.path");
	      System.out.println("Internal/Other Training  : " + Training);
	    }    
    /* End TD-18396 - Training Link updated for disti and reseller user - amalekar*/
    		
    System.out.println("In header.jsp end");
