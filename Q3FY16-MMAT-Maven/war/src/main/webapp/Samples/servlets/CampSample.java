 ...
 * This example shows basic framework.
 */
public class  CampSample extends javax.servlet.http.HttpServlet{
	...
	throws ServletException, IOException{
		try {
			...
			bodySb.append("<BR><BR>");
			bodySb.append("<span class=\"content\"> This example shows basic framework </span>");
			bodySb.append("<BR><BR>");
