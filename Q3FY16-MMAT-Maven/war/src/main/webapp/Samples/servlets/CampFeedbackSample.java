 ...
 * This example shows how to generate a feedback window.
 */
public class  CampFeedbackSample extends javax.servlet.http.HttpServlet{
	...
	throws ServletException, IOException{
		try {
			...
			bodySb.append("<BR><BR>");
			bodySb.append("<span class=\"content\"> This example shows how to generate a feedback window</span>");
			bodySb.append("<BR><BR>");
