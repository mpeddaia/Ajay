 ...
 * demonstrates the usage of Child window.
 */
public class  CampChildSample  extends javax.servlet.http.HttpServlet{
	...
	throws ServletException, IOException{
		try {
			...
			bodySb.append("<BR><BR>");
			bodySb.append("<span class=\"content\"> This example shows how to generate a child window</span>");
			bodySb.append("<BR><BR>");
