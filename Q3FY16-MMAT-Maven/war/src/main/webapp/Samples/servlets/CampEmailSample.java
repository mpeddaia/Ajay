 ...
 * This example shows how to generate a email window.
 */
public class  CampEmailSample extends javax.servlet.http.HttpServlet{
	...
	throws ServletException, IOException{
		try {
			...
			bodySb.append("<BR><BR>");
			bodySb.append("<span class=\"content\"> This example shows how to generate a email window</span>");
			bodySb.append("<BR><BR>");
