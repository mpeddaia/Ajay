 ...
 * This example shows how to generate a print window.
 */
public class  CampPrintSample extends javax.servlet.http.HttpServlet{
	...
	throws ServletException, IOException{
		try {
			...
			bodySb.append("<BR><BR>");
			bodySb.append("<span class=\"content\"> This example shows how to generate a print window</span>");
			bodySb.append("<BR><BR>");
