  ...
  <div id="application_area">
	...
	<img id="moduleIdExpand2" class="mh_expand" onClick="setImageState(this);return toggleElementDisplay(this.parentNode.id + 'block');" src="images/global/buttons_and_icons/icons/green/icn_twirldown_lg_o.gif" alt='Expand/Collapse' height="17" width="17" border="0" />
			<h2 class="mh_title" style="margin-left:15px;">
						Step 2: MCM Processing Times by Request Type
			</h2>	
	 </div>        
							 ...
							 <input name="MAT_RPT_PTR_REQUEST_TYPE" type="hidden" value="" >
							  ...
							  <img src="https://www.cisco.com/apps-ui/generic/interim/images/spacer.gif" width="5" height="5">
                                 <select name="processingMoveRequestType">
									  ...
									  <option value="MAT_T4C">TERMINATION FOR CREDIT</option> <!--  Added as part of Q1FY13 T4C Changes by vibk -->
									 ...
									 <option value="MAT_TERMINATE_SERVICE_LVL" >SERVICE LEVEL TERMINATION</option>
									  <!--Start - Changes added as part of Q4FY13 DNR Changes by sphilipo -->
									  <option value="MAT_DNR_CONTRACT_LVL">DNR FLAG UPDATE CONTRACT LEVEL</option> 
									  <option value="MAT_DNR_SITE_LVL">DNR FLAG UPDATE INSTALL SITE LEVEL</option> 
									  <option value="MAT_DNR_PRODUCT_LVL">DNR FLAG UPDATE PRODUCT LEVEL</option>
									  <!-- End- Changes added as part of Q4FY13 DNR Changes by sphilipo --> 
									  
									   <!--Start - Changes added as part of Q1FY14 SSO Changes by sarhv -->
									    <option value="MAT_CONTRACT_BID_CHANGE"> CONTRACT BID CHANGE </option> 
									   <!-- End- Changes added as part of Q1FY14 SSO Changes by SARHV --> 
