...
<h2 class="mh_title" style="margin-left:15px;">Step 2: MCM Mass Processing Report</h2>
</div>        
...
<tr>
<input type="hidden" name="MAT_RPT_MPR_REQUEST_TYPE" value="">
                              
<td align="left" >
<label for="TEMPLATE">Request Type
<img src="https://www.cisco.com/apps-ui/generic/interim/images/spacer.gif" width="5" height="5">
<img src="https://www.cisco.com/apps-ui/generic/interim/images/spacer.gif" width="5" height="5">
<img src="https://www.cisco.com/apps-ui/generic/interim/images/spacer.gif" width="5" height="5">
<img src="https://www.cisco.com/apps-ui/generic/interim/images/spacer.gif" width="5" height="5">
...
<tr>
<td class="button_left" onClick="document.getElementById('reportSubmit').click();">
</td>
...
<td class="button_right" onClick="document.getElementById('reportSubmit').click();">
</td>
...
<td class="button_left" onClick="document.getElementById('clear').click();">
</td>
									
<td><input id="clear" class="button" type="reset" name="clear" value="Clear" /></td>
									
<td class="button_right" onClick="document.getElementById('clear').click();">
</td>
