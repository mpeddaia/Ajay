...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body marginheight="0" marginwidth="0" onload="javascript:self.focus();">
		...
		<h2><b> <c:out value="${BannerDTO.attribute3}"/></b></h2>
		
		<h1><b> <c:out value="${state}"/></b></h1>
		
		
		<c:forEach var="state" items="${BannerDTO.bannerKeyObj}" varStatus="status">
		    
		        <h1><b> <c:out value="${state}"/></b></h1>
		        <div class="marque_banner">
		        <c:set var="count" value="0" />
				   <c:forEach var="BannerDTO" items="${BannerDTO.bannerMapObj[state]}" varStatus="statusCount"> 
                <div><br></div> 
						...
						<table  border="0" cellspacing="0" cellpadding="0"   >
							...
							<tbody>
								<tr>
								    <td><h2><c:out value="${BannerDTO.startDate}"/></h2></td>							
									<td><h2><b><font size=2><c:out value="${BannerDTO.summaryMessage}"/></font></b></h2></td>
								</tr>
								<tr>	
									<td width="90"></td>
