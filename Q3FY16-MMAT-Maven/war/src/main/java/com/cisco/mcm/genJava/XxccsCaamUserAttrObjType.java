...
public class XxccsCaamUserAttrObjType 
...

{
    ...
    public static Class factoryClass = XxccsCaamUserAttrObjType.class;
    ...
    public static XxccsCaamUserAttrObjType newInstance()
        throws InstantiationException, IllegalAccessException {
        return (XxccsCaamUserAttrObjType) factoryClass.newInstance();
    }

public XxccsCaamUserAttrObjType() {
        attribute=MISSING_CHAR;
        attributeValue=MISSING_CHAR;
...
/* END PROTECT_BLOCK user_member_variables */
    ...
    public XxccsCaamUserAttrObjType loadFromStruct(Connection conn,STRUCT struct) 
        throws SQLException,InstantiationException,IllegalAccessException {
        Object[] attributes=struct.getAttributes();
        attribute=(String)attributes[0];
        attributeValue=(String)attributes[1];
...
/* END PROTECT_BLOCK user_load_from_struct_code */
    ...
    public STRUCT asStruct(Connection conn)
        ...
        STRUCT struct=null;
        StructDescriptor sd=
            StructDescriptor.createDescriptor("APPS.XXCCS_CAAM_USER_ATTR_OBJ_TYPE",conn);
        Object[] attributes = new Object[]{
            ((attribute==null) ? null : new CHAR(attribute,CharacterSet.make(CharacterSet.UTF8_CHARSET))),
            ((attributeValue==null) ? null : new CHAR(attributeValue,CharacterSet.make(CharacterSet.UTF8_CHARSET)))
        };
...
/* END PROTECT_BLOCK user_load_from_struct_code */
    ...
    public static XxccsCaamUserAttrObjType newFromStruct(Connection conn,STRUCT struct) 
        throws SQLException,InstantiationException,IllegalAccessException {
        XxccsCaamUserAttrObjType newInstance=newInstance();
...
/* END PROTECT_BLOCK user_new_from_struct_code */
    ...
    public Object clone() throws CloneNotSupportedException {
        XxccsCaamUserAttrObjType theClone = (XxccsCaamUserAttrObjType) super.clone();
    ...
    public int hashCode() {
        ...
        hashStringBuffer.append("attribute=").append(attribute);
        hashStringBuffer.append("attributeValue=").append(attributeValue);
