...
public class XxcssScmValOverideType 
...

{
    ...
    public static Class factoryClass = XxcssScmValOverideType.class;
    ...
    public static XxcssScmValOverideType newInstance()
        throws InstantiationException, IllegalAccessException {
        return (XxcssScmValOverideType) factoryClass.newInstance();
    }

public XxcssScmValOverideType() {
        upldDefinitionName=MISSING_CHAR;
        upldValidationCode=MISSING_CHAR;
        upldValidationDesc=MISSING_CHAR;
...
/* END PROTECT_BLOCK user_member_variables */
    ...
    private String upldValidationCode;
    private String upldValidationDesc;
    ...
    public String getUpldValidationCode() {
        return upldValidationCode;
    }
    public String getUpldValidationDesc() {
        return upldValidationDesc;
    }
    ...
    public void setUpldValidationCode(String aUpldValidationCode) {
        upldValidationCode = aUpldValidationCode;
    }
    public void setUpldValidationDesc(String aUpldValidationDesc) {
        upldValidationDesc = aUpldValidationDesc;
    }
    ...
    public XxcssScmValOverideType loadFromStruct(Connection conn,STRUCT struct) 
        throws SQLException,InstantiationException,IllegalAccessException {
        Object[] attributes=struct.getAttributes();
        upldDefinitionName=(String)attributes[0];
        upldValidationCode=(String)attributes[1];
        upldValidationDesc=(String)attributes[2];
...
/* END PROTECT_BLOCK user_load_from_struct_code */
    ...
    public STRUCT asStruct(Connection conn)
        ...
        STRUCT struct=null;
        StructDescriptor sd=
            StructDescriptor.createDescriptor("APPS.XXCSS_SCM_VAL_OVERIDE_TYPE",conn);
        Object[] attributes = new Object[]{
            ((upldDefinitionName==null) ? null : new CHAR(upldDefinitionName,CharacterSet.make(CharacterSet.UTF8_CHARSET))),
            ((upldValidationCode==null) ? null : new CHAR(upldValidationCode,CharacterSet.make(CharacterSet.UTF8_CHARSET))),
            ((upldValidationDesc==null) ? null : new CHAR(upldValidationDesc,CharacterSet.make(CharacterSet.UTF8_CHARSET)))
        };
...
/* END PROTECT_BLOCK user_load_from_struct_code */
    ...
    public static XxcssScmValOverideType newFromStruct(Connection conn,STRUCT struct) 
        throws SQLException,InstantiationException,IllegalAccessException {
        XxcssScmValOverideType newInstance=newInstance();
...
/* END PROTECT_BLOCK user_new_from_struct_code */
    ...
    protected void appendToStringAttributes(StringBuffer sb) {
        ...
        sb.append(",upldValidationCode=").append(upldValidationCode);
        sb.append(",upldValidationDesc=").append(upldValidationDesc);

    }
    
    public Object clone() throws CloneNotSupportedException {
        XxcssScmValOverideType theClone = (XxcssScmValOverideType) super.clone();
    ...
    public int hashCode() {
        ...
        hashStringBuffer.append("upldValidationCode=").append(upldValidationCode);
        hashStringBuffer.append("upldValidationDesc=").append(upldValidationDesc);
